  ...
  return (
    <SafeAreaView edges={['top']} style={[s.container, { backgroundColor: t.bg }]}>
      <View style={[s.header, { borderBottomColor: t.cardBorder }]}>
        ...
        <Text style={[s.title, { color: t.text }]}>개인 정보</Text>
      ...
      <ScrollView contentContainerStyle={s.content}>
        <View style={[s.placeholderCard, { backgroundColor: t.card, borderColor: t.cardBorder }]}>
          ...
          <Text style={[s.placeholderTitle, { color: t.text }]}>개인 정보 관리</Text>
          <Text style={[s.placeholderDesc, { color: t.textSecondary }]}>
            이름, 이메일, 생년월일 등 기본 프로필 정보를 수정하는 화면입니다.
          </Text>
          <View style={[s.comingSoon, { borderColor: 'rgba(124,58,237,0.4)', backgroundColor: 'rgba(124,58,237,0.08)' }]}>
            <Text style={[s.comingSoonText, { color: '#7C3AED' }]}>Coming Soon</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
