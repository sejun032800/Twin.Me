/**
 * Platform-agnostic HTML builder for the Kakao/Leaflet map embed.
 * No native imports — safe to import from both .tsx and .web.tsx.
 */
...
export const isMockMode = JS_KEY === 'MOCK_JS_KEY' || JS_KEY === '';
...
<body>
  ...
  <script>
    ...
    /* ── Message bus (RN → WebView / parent → iframe) ────────────────── */
